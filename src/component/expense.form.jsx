...
function Expense() {
  ...
  const getExpenses = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/expense/all`, {
  ...
  const addExpense = async () => {
    try {
      ...
      await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/expense/add`, data, {
        headers: {
          ...getAuthHeader(),
  ...
  const updateExpense = async () => {
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_BACKEND_URL}/api/expense/update/${editId}`,
        data,
        {
          headers: {
            ...getAuthHeader(),
  ...
  const deleteExpense = async (id) => {
    ...
    try {
      await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/expense/delete/${id}`, {
        headers: getAuthHeader(),
      });
